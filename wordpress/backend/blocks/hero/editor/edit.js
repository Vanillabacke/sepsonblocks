...
import useRichText from '../../blockControls/useRichText'
...
function Edit(props) {
    ...
    const {
        // richTextControl: headlineControl
        richTextControl: HeadlineControl
    } = useRichText( props, 'headline', {
        allowedFormats: [],
        tagName: 'h1',
    ...
    const {
        // richTextControl: sublineControl
        richTextControl: SublineControl
    } = useRichText( props, 'subline', {
    ...
    const {
        // richTextControl: ctaLabelControl
        richTextControl: CtaLabelControl
    } = useRichText( props, 'ctaLabel', {
        allowedFormats: [],
        tagName: 'button',
...
// {/* <p>_mediaId {_mediaId || '-'}</p> */}
// {/* <p>_mediaUrl {_mediaUrl || '-'}</p> */}
//         {headlineControl}
//         {sublineControl}
//         {ctaLabelControl}
