...
export default(props) => {
    ...
    const createRange = (node, chars, length) => {
        ...
        range.setStart(node.childNodes[0], chars);
        range.setEnd(node.childNodes[0], chars + length);
    ...
    const onBoundary = (event) => {
        ...
        createRange(ref.current, event.charIndex, event.charLength)
    ...
    return <div className="reader-wrapper">
        ...
        <div ref={ref} contenteditable={true}>{ props.children }</div> 
