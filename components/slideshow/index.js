...
import DefaultSlideComp from './slide.comp'
...
const customTag    = 'vc-slideshow'
const customSlideTag    = 'vc-slide'
// const extendTag    = 'nav'
...
function register( tag = false ) {
    ...
    // import(/* webpackChunkName: "hook-tester" */ './comp').then( ({default: DefaultComp}) => {
        ...
        registerCustomElement(DefaultSlideComp, customSlideTag , [], { shadow: shadowDOM, 
            extends: extendTag
        });
